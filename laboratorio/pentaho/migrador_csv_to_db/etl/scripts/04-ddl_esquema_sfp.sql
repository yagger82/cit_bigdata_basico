...
CREATE TABLE sfp.periodo (
                ...
                mes_descripcion VARCHAR(16) NOT NULL,
...
COMMENT ON COLUMN sfp.funcionario.estado_id IS 'Clave foránea para relacionar con la tabla estado';
...
CREATE INDEX funcionario_puesto_fk_idx
 ...
 ( funcionario_id ASC, cargo_id ASC, profesion_id ASC, anho_ingreso ASC );
...
ALTER TABLE sfp.funcionario ADD CONSTRAINT tipo_funcionario_funcionario_fk
